  ...
  return (
    <>
      ...
      <footer className="bg-[#FBF6F0] px-4 md:px-20 py-10">
        {/* Top row: Whiskers | Suporte */}
        <div className="grid grid-cols-2 gap-10">
          <div>
            <ul>
              <li className="my-4">
                <span className="opacity-60">Whiskers</span>
              </li>
          ...
          <div>
            <ul>
              <li className="my-4">
                <span className="opacity-60">Suporte</span>
              </li>
        ...
        <div className="grid grid-cols-2 gap-10 mt-8">
          ...
          <div>
            <ul>
              <li className="my-4">
                <span className="opacity-60">Siga-nos</span>
              </li>
