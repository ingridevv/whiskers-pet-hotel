...
const decorations = [
  {
    ...
    className: "hidden sm:block absolute bottom-5 sm:bottom-10 left-0 w-32 sm:w-56 md:w-[560px] z-20"
  },
  {
    src: dog,
    alt: "Friendly Basenji Dog",
    className: "hidden sm:block absolute bottom-0 sm:bottom-5 right-0 w-40 sm:w-60 md:w-[500px] z-5"
  },
  {
    src: starTopLeft,
    alt: "Bright Yellow Star",
    className: "absolute top-5 sm:top-10 left-10 sm:left-16 w-16 sm:w-24 md:w-32 z-[-1]"
  },
  {
    src: starBottomLeft,
    alt: "Bright Yellow Star",
    className: "absolute bottom-20 sm:bottom-32 left-10 sm:left-24 w-12 sm:w-16 md:w-24 z-[-1]"
  },
  {
    src: starRight,
    alt: "Bright Yellow Star",
    className: "absolute top-5 sm:top-10 right-10 sm:right-20 w-12 sm:w-16 md:w-24 z-[-1]"
  },
  {
    src: portraitLeft,
    alt: "Woman kissing dog lovingly",
    className: "absolute top-20 sm:top-32 left-5 sm:left-12 w-24 sm:w-32 md:w-40 z-[-1]"
  },
  {
    src: portraitRight,
    alt: "Woman kissing dog lovingly",
    className: "absolute top-40 sm:top-60 right-5 sm:right-12 w-20 sm:w-32 md:w-40 z-[-1]"
  },
  {
    src: portraitBottom,
    alt: "Woman kissing dog lovingly",
    className: "absolute bottom-10 sm:bottom-20 right-20 sm:right-32 w-20 sm:w-32 md:w-40 z-0"
  },
];
  ...
  return (
    <section className="relative flex flex-col w-full min-h-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 z-10 text-center">
        ...
        >
          Um lugar seguro e divertido para o seu pet enquanto você viaja ou trabalha.
        </h1>
